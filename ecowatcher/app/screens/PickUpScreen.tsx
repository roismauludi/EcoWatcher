      ...
      <View style={styles.contentContainer} key={index}>
        ...
        <View style={styles.detailInfoContainer}>
          ...
          <TouchableOpacity
              ...
              onPress={() => {
                const itemId = item.items[0]?.itemId;  // Ambil itemId dari item pertama dalam array items
                if (itemId) {
                  console.log('Navigating to Rincian with id:', itemId);
                  navigation.navigate('Rincian', { id: itemId });
                } else {
