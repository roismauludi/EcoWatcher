...
import { Modal, Button, Text, View, ScrollView, Image, StyleSheet, TextInput } from 'react-native';
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalDescription}>
              ...
              <Text style={styles.boldText}>{pickupData?.userId}</Text>
            </Text>
            ...
            <View style={styles.modalFooter}>
              <Button title="Batal" onPress={closeTrackStatusModal} />
              <Button
                title="Simpan"
                onPress={() => handleTrackStatusChange(newStatus)} // Panggil fungsi untuk menyimpan status baru
              />
            </View>
          </View>
        </View>
